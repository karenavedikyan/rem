...
export function readCurrentPartnerId(req) {
  // TODO(auth): replace partnerId fallback with real authenticated user context.
  ...
  const value = asString(queryId || headerId || process.env.REMCARD_PARTNER_ID || DEFAULT_PARTNER_ID);
  return value || DEFAULT_PARTNER_ID;
}
