(() => {
  ...
  const EN_DICT = {
    ...
    "Контакты": "Contacts",
    "Главная": "Home",
    "RemCard — Контакты": "RemCard — Contacts",
    ...
    "Связанный сценарий этапов": "Connected stage scenario",
    ...
    "На какой стадии ваш ремонт и что нужно сделать.": "What stage your renovation is at and what needs to be done.",
    "2. Получите план и бюджет": "2. Get plan and budget",
    "Видите этапы, примерные сроки и диапазон затрат.": "See stages, estimated timeline, and cost range.",
    "3. Оформите одну заявку": "3. Submit one request",
    "Мы подберём мастеров и магазины под ваш запрос.": "We match contractors and stores to your request.",
    "Этап": "Stage",
    "Этапы ремонта RemCard": "RemCard renovation stages",
    "Таймлайн из трёх шагов": "Three-step timeline",
    "Что получает клиент с RemCard": "What clients get with RemCard",
    "Экономия времени": "Save time",
    "1 заявка вместо десятков звонков.": "One request instead of dozens of calls.",
    "Понятный план ремонта": "Clear renovation plan",
    "Этапы, сроки и бюджет на одном экране.": "Stages, timeline, and budget on one screen.",
    "Подбор мастеров": "Contractor matching",
    "Исполнители под ваш район и бюджет.": "Contractors matched to your district and budget.",
    "Бонусы за покупки": "Bonuses for purchases",
    "Начисляем бонусы за ремонт и покупки у партнёров.": "We award bonuses for renovations and partner purchases.",
    "Для мастеров и компаний": "For contractors and companies",
    "Целевые заявки": "Targeted leads",
    "Клиенты с понятными задачами и бюджетом.": "Clients with clear tasks and budget.",
    "Каталог услуг и товаров": "Services and products catalog",
    "Размещение в навигаторе ремонта.": "Listing inside the repair navigator.",
    "Акции и бонусы": "Promotions and bonuses",
    "Участие в программе лояльности RemCard.": "Participation in the RemCard loyalty program.",
    "Видите сумму заказа, начисление и оплату бонусами в одном блоке.":
      "See order amount, bonus accrual, and bonus payment in one block.",
    "Сумма заказа": "Order amount",
    "Начисленные бонусы": "Earned bonuses",
    "2 000 бонусов": "2,000 bonuses",
    "Пример оплаты следующей покупки": "Example of paying for the next purchase",
    "Начисление и списание прозрачны. Вы заранее видите, сколько бонусов получите и где потратите.":
    ...
    "Заполните форму и получите обратную связь от команды RemCard.": "Fill in the form and get feedback from the RemCard team.",
    "Ключевые выгоды с первого взгляда": "Key benefits at a glance",
    "1 заявка": "1 request",
    "и несколько предложений": "and several offers",
    "5 этапов": "5 stages",
    "в навигаторе ремонта": "inside the repair navigator",
    "Клиент · мастер · магазин": "Client · contractor · store",
    "одна платформа RemCard": "one RemCard platform",
    ...
    "Заявка, каталог, акции и бонусы — всё в одном месте.": "Request, catalog, promotions, and bonuses — all in one place.",
    "Заявка, каталог, бонусы — всё в одном месте.": "Request, catalog, bonuses — all in one place.",
    "Понятный путь: от задачи до выбора исполнителя.": "A clear path: from task to choosing a contractor.",
    "От задачи до выбора исполнителя.": "From task to choosing a contractor.",
    "Бонусы за ремонт и покупки у партнёров RemCard.": "Bonuses for renovation and purchases from RemCard partners.",
    "Вознаграждаем за покупки у партнёров.": "We reward purchases at partner stores.",
    ...
    "Как начисляются и тратятся бонусы RemCard — в 3 шага.": "How RemCard bonuses are earned and spent — in 3 steps.",
    "Заказ": "Order",
    "Оплата бонусами": "Paid with bonuses",
    "Следующая покупка": "Next purchase",
    "Начисление и списание прозрачны: видите выгоду до оплаты.": "Earning and spending are transparent: you see savings before payment.",
    "Как ускорить подбор": "How to speed up matching",
    "Заполните ключевые поля: тип задачи, район и бюджет.": "Fill in key fields: task type, district, and budget.",
    "Оставьте контакт, где вам удобно ответить.": "Leave a contact where it's convenient for you to reply.",
    "Получите обратную связь и подходящие предложения.": "Get feedback and suitable offers.",
    "Сейчас работаем в Краснодаре.": "Currently operating in Krasnodar.",
    ...
    "Контакты": "Contacts",
    "Контакты RemCard": "RemCard Contacts",
    ...
    "Срок": "Timeline",
    "Бюджет": "Budget",
    "Кто нужен": "Who you need",
    "Главный инсайт": "Main insight",
  ...
  Object.assign(EN_DICT, {
    ...
    "Контакты RemCard и форма обратной связи клиентов: предложения, претензии и отзывы.":
      "RemCard contacts and client feedback form: suggestions, complaints, and reviews.",
    "Написать": "Write to us",
    ...
    "Отзывы и обратная связь клиентов": "Client feedback and claims",
    "Обратная связь, претензии и предложения помогают улучшать RemCard.":
      "Feedback, complaints, and suggestions help improve RemCard.",
    "Тип обращения": "Request type",
    "Выберите тип": "Select type",
    "Обратная связь": "Feedback",
    "Претензия": "Complaint",
    "Предложение": "Suggestion",
    "Тема (опционально)": "Subject (optional)",
    "Коротко о теме обращения": "Brief subject",
    "Сообщение": "Message",
    "Опишите вашу ситуацию, предложение или замечание": "Describe your situation, suggestion, or concern",
    "Имя (опционально)": "Name (optional)",
    "Телефон / Telegram / Email": "Phone / Telegram / Email",
    "+7 (...) ...-..-.. / @telegram / email": "+7 (...) ...-..-.. / @telegram / email",
    "Отправить отзыв": "Send feedback",
    "Мы читаем все обращения и при необходимости связываемся для уточнений.":
      "We read all submissions and contact you if clarification is needed.",
    "Отзыв отправлен. Спасибо за обратную связь.": "Feedback sent. Thank you for sharing.",
