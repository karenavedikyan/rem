(() => {
  ...
  const EN_DICT = {
    ...
    "RemCard — Заявка": "RemCard — Request",
    "RemCard — Личный кабинет клиента": "RemCard — Client Cabinet",
    "RemCard — Документы": "RemCard — Documents",
    "RemCard — Политика конфиденциальности": "RemCard — Privacy Policy",
    "RemCard — Пользовательское соглашение": "RemCard — Terms of Use",
